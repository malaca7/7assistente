...
export const initialAccessUsers: SystemAccessUser[] = [
  ...
  {
    id: 'user-att-2',
    name: 'Camila Lima (Consultora Ipojuca)',
    username: 'consultora', // APENAS LETRAS
    password: '123456', // APENAS NÚMEROS
    panels: ['atendimento'],
    store_id: 'store-002',
    store_name: 'Loja Ipojuca - Filial',
    status: 'active',
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
...
export const sampleFlows: Flow[] = [
  ...
  {
    id: 'flow-pitoco-004',
    name: 'Recepção Direcionada Loja Ipojuca - Filial',
    description: 'Atendimento e suporte aos clientes da Loja Ipojuca - Filial.',
    status: 'paused',
    is_active: false,
    version: 1,
    node_count: 4,
    trigger_type: 'Transbordo Loja Ipojuca',
    store_id: 'store-002',
    store_name: 'Loja Ipojuca - Filial',
    steps: [
      { id: 'step-blv-1', title: 'Gatilho Ipojuca', type: 'trigger', category: 'Início', description: 'Cliente selecionou Loja Ipojuca.' },
      { id: 'step-blv-2', title: 'Localização Ipojuca', type: 'message', category: 'Informativo', description: 'Instruções para encontrar a loja em Ipojuca - PE.' },
      { id: 'step-blv-3', title: 'Conectar com Camila', type: 'human_handoff', category: 'Transbordo', description: 'Direciona conversa para a equipe de Ipojuca.' },
    ],
