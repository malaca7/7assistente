...
export const StorageService = {
  ...
  async getAgendaSettings(): Promise<AgendaSettings> {
    ...
    return getItem<AgendaSettings>(STORAGE_KEYS.AGENDA_SETTINGS, {
      ...
      buffer_minutes: 5,
      day_schedules: {
        '1': { enabled: true, start_time: '08:00', end_time: '19:00', has_break: true, break_start_time: '12:00', break_end_time: '13:00' },
        '2': { enabled: true, start_time: '08:00', end_time: '19:00', has_break: true, break_start_time: '12:00', break_end_time: '13:00' },
        '3': { enabled: true, start_time: '08:00', end_time: '19:00', has_break: true, break_start_time: '12:00', break_end_time: '13:00' },
        '4': { enabled: true, start_time: '08:00', end_time: '19:00', has_break: true, break_start_time: '12:00', break_end_time: '13:00' },
        '5': { enabled: true, start_time: '08:00', end_time: '19:00', has_break: true, break_start_time: '12:00', break_end_time: '13:00' },
        '6': { enabled: true, start_time: '08:00', end_time: '18:00', has_break: true, break_start_time: '12:00', break_end_time: '13:00' },
        '0': { enabled: false, start_time: '08:00', end_time: '13:00', has_break: false, break_start_time: '12:00', break_end_time: '13:00' },
      },
      min_advance_booking_minutes: 30,
      max_advance_booking_days: 30,
      cancellation_notice_hours: 2,
      auto_reminder_hours: 2,
      allow_waiting_list: true,
      simultaneous_barbers: 1,
