...
export const DashboardPage: React.FC<DashboardPageProps> = ({ onNavigate }) => {
  ...
  const kpiCards = [
    ...
    },
    {
      ...
      value: kpis?.activeConversations.toString() || '0',
      change: 'Em atendimento agora',
      icon: MessageSquare,
    ...
    {
      title: 'Fluxos Ativos',
      value: kpis?.activeFlows.toString() || '0',
      change: `${flows.length} fluxos totais cadastrados`,
      icon: GitFork,
    ...
    },
    {
      ...
      value: kpis?.waitingHuman.toString() || '0',
