  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <Card className="md:col-span-7 flex flex-col items-center justify-center p-8 bg-dark-900 border-white/10 text-center relative overflow-hidden">
          {isConnected ? (
            <div className="text-center p-6 space-y-4 w-full">
              <div className="w-16 h-16 rounded-3xl bg-emerald-500/15 border border-emerald-500/30 flex items-center justify-center text-emerald-400 mx-auto shadow-lg shadow-emerald-500/10">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1 max-w-sm mx-auto">
                  Seu robô está online e ativo na Discloud, processando conversas e transbordos em tempo real.
                </p>
                {session.phone && (
                  <div className="mt-3">
              ...
              <div className="pt-2">
                <Button
                  ...
                  size="sm"
                  onClick={async () => {
                    if (window.confirm('Deseja realmente desconectar o WhatsApp? O bot deixará de responder até uma nova conexão.')) {
                      await disconnect();
                    }
                  }}
                  className="border-rose-500/30 text-rose-400 hover:bg-rose-500/10 text-xs font-bold px-4 py-2"
                >
                  <Power className="w-3.5 h-3.5 mr-1.5" />
