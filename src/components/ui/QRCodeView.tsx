...
export const QRCodeView: React.FC<QRCodeViewProps> = ({
  ...
  const [pairingCode, setPairingCode] = useState('7AST-1994');
  ...
  const handleGeneratePairingCode = () => {
    ...
    // Generate authentic 8-char WhatsApp pairing code (e.g. 4 letters/digits - 4 letters/digits)
        ...
        <div className="w-full max-w-md p-5 rounded-2xl bg-dark-850 border border-slate-800 space-y-5 animate-in fade-in duration-200">
          <div className="space-y-1 text-center">
            ...
            <p className="text-xs text-slate-400">
              Digite seu número e insira o código de 8 dígitos gerado no seu aplicativo do WhatsApp.
            </p>
          </div>

          <div className="space-y-3">
            <div>
              <label className="block text-xs font-medium text-slate-300 mb-1">Seu Número com DDD</label>
            ...
            <div className="p-4 rounded-xl bg-dark-950 border-2 border-emerald-500/40 flex flex-col items-center justify-center space-y-2">
              ...
              <p className="text-[11px] text-slate-400 text-center">
                Abra o WhatsApp &gt; Aparelhos Conectados &gt; Conectar com número de telefone.
              </p>
            </div>
            ...
            <Button
              ...
              isLoading={isLoading}
            >
              Confirmar Pareamento do Aparelho
            </Button>
          </div>
        </div>
      )}
